...
function FreindesRequests():ReactElement {
    ...
    const handleDelete = useCallback((async(friend:number)=>{
        try{
            const url = baseUrl+`/user/cancelFriend/${friend}`;
            ...
            <>
                ...
                return(
                    ...
                    <div className='flex w-full justify-start items-center'>
                        ...
                        {openAlert&&<CustomAlert callBackFn={handleDelete} setOpenAlert={setOpenAlert} friendId={el.userId} />}
                    </div>
